...
webr: 
  ...
  packages: ['ggplot2', 'dplyr', 'scales', 'unvotes', 'ggthemes', 'lubridate']
filters:
  - webr
---
...
We will use the **dplyr**, **ggplot2**, **ggthemes** **lubridate**, and **scales** packages for data wrangling and visualization, and the **unvotes** package for the data.
