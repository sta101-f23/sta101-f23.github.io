...
webr: 
  ...
  packages: ['ggplot2', 'dplyr', 'forcats', 'tidyr']
filters:
  - webr
---
...
#| context: setup
download.file(
  "https://raw.githubusercontent.com/sta101-f23/sta101-f23.github.io/main/ae/data/durham-2020.csv",
  "durham-2020.csv"
)
```
...
```{webr-r}
#| label: load-data
durham <- read.csv("durham-2020.csv")
```
